...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Keep loading=true here — this page unmounts on navigation,
    // so there's nothing to reset. Resetting it before push()
    // caused the button to snap back to "Sign in" while the
    // dashboard route was still being fetched.
